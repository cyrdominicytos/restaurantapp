...
import { EntityArrayResponseType, CommandesService } from '../service/commandes.service';
...
export class CommandesComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICommandes): number => this.commandesService.getCommandesIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.commandes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICommandes[] | null): ICommandes[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.commandesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
