...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.CommandesProductItem}.
 */
@RestController
@RequestMapping("/api")
public class CommandesProductItemResource {
     ...
     */
    @PostMapping("/commandes-product-items")
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/commandes-product-items/{id}")
    public ResponseEntity<CommandesProductItem> updateCommandesProductItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commandesProductItem.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/commandes-product-items/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<CommandesProductItem> partialUpdateCommandesProductItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commandesProductItem.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/commandes-product-items")
     ...
     */
    @GetMapping("/commandes-product-items/{id}")
    public ResponseEntity<CommandesProductItem> getCommandesProductItem(@PathVariable Long id) {
     ...
     */
    @DeleteMapping("/commandes-product-items/{id}")
    public ResponseEntity<Void> deleteCommandesProductItem(@PathVariable Long id) {
