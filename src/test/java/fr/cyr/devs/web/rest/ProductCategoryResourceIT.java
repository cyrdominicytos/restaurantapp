...
class ProductCategoryResourceIT {
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(DEFAULT_NAME).ordre(DEFAULT_ORDRE);
    ...
    public static ProductCategory createUpdatedEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(UPDATED_NAME).ordre(UPDATED_ORDRE);
        return productCategory;
    }
    ...
    void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getOrdre()).isEqualTo(DEFAULT_ORDRE);
    }
    ...
    void putExistingProductCategory() throws Exception {
        ...
        updatedProductCategory.name(UPDATED_NAME).ordre(UPDATED_ORDRE);
        ...
        assertThat(testProductCategory.getOrdre()).isEqualTo(UPDATED_ORDRE);
    }
    ...
    void fullUpdateProductCategoryWithPatch() throws Exception {
        ...
        partialUpdatedProductCategory.name(UPDATED_NAME).ordre(UPDATED_ORDRE);
