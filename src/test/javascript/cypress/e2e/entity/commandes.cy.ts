...
describe('Commandes e2e test', () => {
  ...
  const commandesSample = { amount: 22289.98 };
  ...
  describe('new Commandes page', () => {
    ...
    it('should create an instance of Commandes', () => {
      cy.get(`[data-cy="amount"]`).type('3815.54');
      cy.get(`[data-cy="amount"]`).should('have.value', '3815.54');

      cy.get(`[data-cy="createdDate"]`).type('2024-02-02T07:24');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2024-02-02T07:24');

      cy.get(`[data-cy="recoveryDate"]`).type('2024-02-02T00:27');
      cy.get(`[data-cy="recoveryDate"]`).blur();
      cy.get(`[data-cy="recoveryDate"]`).should('have.value', '2024-02-02T00:27');

      cy.get(`[data-cy="updatedDate"]`).type('2024-02-01T09:37');
      cy.get(`[data-cy="updatedDate"]`).blur();
      cy.get(`[data-cy="updatedDate"]`).should('have.value', '2024-02-01T09:37');
