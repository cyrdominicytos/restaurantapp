...
describe('Formula e2e test', () => {
  ...
  describe('new Formula page', () => {
    ...
    it('should create an instance of Formula', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2024-02-01T12:34').blur().should('have.value', '2024-02-01T12:34');

      cy.get(`[data-cy="updatedDate"]`).type('2024-01-31T20:10').blur().should('have.value', '2024-01-31T20:10');
