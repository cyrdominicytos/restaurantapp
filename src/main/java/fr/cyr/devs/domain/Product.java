...
public class Product implements Serializable {
    ...
    public CommandesProductItem getCommandesProductItem() {
        return this.commandesProductItem;
    }

    public void setCommandesProductItem(CommandesProductItem commandesProductItem) {
        if (this.commandesProductItem != null) {
            this.commandesProductItem.setProduct(null);
        }
        if (commandesProductItem != null) {
            commandesProductItem.setProduct(this);
        }
        this.commandesProductItem = commandesProductItem;
    }

    public Product commandesProductItem(CommandesProductItem commandesProductItem) {
        this.setCommandesProductItem(commandesProductItem);
        return this;
    }
