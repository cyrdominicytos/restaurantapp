...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Formula}.
 */
@RestController
@RequestMapping("/api")
public class FormulaResource {
    ...
    public ResponseEntity<Formula> updateFormula(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, formula.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Formula> partialUpdateFormula(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, formula.getId().toString())
        );
    }
