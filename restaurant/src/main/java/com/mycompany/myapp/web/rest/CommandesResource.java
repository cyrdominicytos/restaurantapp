...
public class CommandesResource {
    ...
    public ResponseEntity<Commandes> updateCommandes(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commandes.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Commandes> partialUpdateCommandes(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commandes.getId().toString())
        );
    }
