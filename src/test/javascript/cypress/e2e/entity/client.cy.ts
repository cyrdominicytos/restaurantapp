...
describe('Client e2e test', () => {
  ...
  const clientSample = { firstName: 'Hervé', lastName: 'Rousseau' };
  ...
  describe('new Client page', () => {
    ...
    it('should create an instance of Client', () => {
      cy.get(`[data-cy="firstName"]`).type('Inès');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Inès');

      cy.get(`[data-cy="lastName"]`).type('Fontaine');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Fontaine');

      cy.get(`[data-cy="address"]`).type('fonctionnaire');
      cy.get(`[data-cy="address"]`).should('have.value', 'fonctionnaire');

      cy.get(`[data-cy="phoneNumber"]`).type('abolir instruire');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'abolir instruire');

      cy.get(`[data-cy="createdDate"]`).type('2024-02-01T18:25');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2024-02-01T18:25');

      cy.get(`[data-cy="updatedDate"]`).type('2024-02-01T23:35');
      cy.get(`[data-cy="updatedDate"]`).blur();
      cy.get(`[data-cy="updatedDate"]`).should('have.value', '2024-02-01T23:35');
