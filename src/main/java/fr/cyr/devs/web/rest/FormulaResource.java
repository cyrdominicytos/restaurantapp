...
import fr.cyr.devs.repository.FormulaRepository;
import fr.cyr.devs.service.FormulaService;
...
/**
 * REST controller for managing {@link fr.cyr.devs.domain.Formula}.
 */
@RestController
...
public class FormulaResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Formula>> getAllFormulas(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
