...
/**
 * REST controller for managing {@link fr.cyr.devs.domain.CommandesFormulaItem}.
 */
@RestController
@RequestMapping("/api/commandes-formula-items")
public class CommandesFormulaItemResource {
    ...
    public ResponseEntity<CommandesFormulaItem> updateCommandesFormulaItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, commandesFormulaItem.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CommandesFormulaItem> partialUpdateCommandesFormulaItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, commandesFormulaItem.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<CommandesFormulaItem> getCommandesFormulaItem(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCommandesFormulaItem(@PathVariable("id") Long id) {
