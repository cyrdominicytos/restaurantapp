...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'à seule fin de jeune touriste' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('en face de tenter');
      cy.get(`[data-cy="name"]`).should('have.value', 'en face de tenter');

      cy.get(`[data-cy="ordre"]`).type('15118');
      cy.get(`[data-cy="ordre"]`).should('have.value', '15118');
