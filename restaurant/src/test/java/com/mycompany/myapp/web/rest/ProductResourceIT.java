...
class ProductResourceIT {
    ...
    private static final Boolean DEFAULT_IS_SUPPLEMENT = false;
    private static final Boolean UPDATED_IS_SUPPLEMENT = true;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .isSupplement(DEFAULT_IS_SUPPLEMENT)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .isSupplement(UPDATED_IS_SUPPLEMENT)
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getImageType()).isEqualTo(DEFAULT_IMAGE_TYPE);
        assertThat(testProduct.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testProduct.getIsSupplement()).isEqualTo(DEFAULT_IS_SUPPLEMENT);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].isSupplement").value(hasItem(DEFAULT_IS_SUPPLEMENT.booleanValue())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.isSupplement").value(DEFAULT_IS_SUPPLEMENT.booleanValue()))
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getImageType()).isEqualTo(UPDATED_IMAGE_TYPE);
        assertThat(testProduct.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testProduct.getIsSupplement()).isEqualTo(UPDATED_IS_SUPPLEMENT);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.description(UPDATED_DESCRIPTION).isSupplement(UPDATED_IS_SUPPLEMENT);
