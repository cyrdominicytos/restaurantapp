...
describe('Commandes Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'commandes', component: CommandesComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to commandesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCommandesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCommandesIdentifier).toHaveBeenCalledWith(entity);
