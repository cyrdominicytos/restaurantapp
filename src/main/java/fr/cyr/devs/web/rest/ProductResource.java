...
/**
 * REST controller for managing {@link fr.cyr.devs.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    public ResponseEntity<List<Product>> getAllProducts(
        ...
        if ("commandesproductitem-is-null".equals(filter)) {
            log.debug("REST request to get all Products where commandesProductItem is null");
            return new ResponseEntity<>(productService.findAllWhereCommandesProductItemIsNull(), HttpStatus.OK);
        }
